...
public class ImageAnalyzer {
    ...
    public String extractMetadata(String textPrompt, String base64Image) {
        ...
        try {
            ...
            if(response.statusCode() == 200) {
                ...
                return cleanUpResponse(jsonResponse.get("choices").get(0).get("message").get("content").asText());
            } else {
                logError(response);
            }
    ...
    private static HttpRequest getHttpRequest(String requestBody) {
        return HttpRequest.newBuilder().uri(URI.create("https://api.groq.com/openai/v1/chat/completions"))
    ...
    private static String cleanUpResponse(String content) {
